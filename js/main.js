...
function initAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.service-card, .stat-item, .value-card, .facility-card, .certificate-card, .team-member, .info-card, .share-option, .appointment-option');
