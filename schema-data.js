...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const organizationSchema = {
        ...
        "description": "Centre d'amincissement médicalisé en Tunisie, spécialisé en Cellu M6, lipocryolyse, I.motion et omeoenergetica. Solutions d'amincissement personnalisées sous supervision médicale par Dr. Anis Jday.",
        "address": {
            "@type": "PostalAddress",
    ...
    const doctorSchema = {
        ...
        "@type": "Physician",
        "name": "Dr. Anis Jday",
        "image": "https://vitalia.tn/assets/team/dr-anis-jday.svg",
        "description": "Référence en amincissement médical et nutrition en Tunisie avec plus de 15 ans d'expérience",
    ...
    const servicesSchema = {
        ...
        "description": "Solutions d'amincissement personnalisées incluant perte de poids, raffermissement, bien-être et suivi sur mesure",
        "about": {
            "@type": "MedicalBusiness",
            "name": "Vitalia - Centre d'Amincissement",
            "url": "https://vitalia.tn/"
        ...
        "mainContentOfPage": [
            {
                ...
                "description": "Solutions personnalisées pour une perte de poids saine et durable",
                "followup": "Suivi personnalisé par des experts"
            },
            {
                "@type": "MedicalProcedure",
                "name": "Raffermissement",
                "description": "Techniques avancées pour raffermir votre corps et tonifier votre peau",
    ...
    if (currentURL.includes('dr-anis-jday') || currentURL === '/dr-anis-jday.html') {
        injectSchema(doctorSchema);
    } else if (currentURL.includes('services') || currentURL === '/services.html') {
